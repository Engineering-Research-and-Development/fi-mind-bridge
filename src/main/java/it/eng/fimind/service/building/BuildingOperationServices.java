...
public class BuildingOperationServices {
	...
	public Response deleteIt(@QueryParam("id") String id) {
		logger.debug("[BuildingOperationServices] DELETE Request");
	...
	public Response createDataInJSON(@HeaderParam("debug-mode") String debugMode, @Valid BuildingOperation buildingOperation) { 
		logger.debug("[BuildingOperationServices] POST Request");
		ServiceResult serviceResult = new ServiceResult();
		...
		if(debugMode!=null && debugMode.equals("true")){
			...
			Boolean result = true;
			MindSphereGateway mindSphereGateway = MindSphereGateway.getMindSphereGateway();
			if(!mindSphereGateway.assetDoesAlreadyExist(buildingOperation.getId())) 
